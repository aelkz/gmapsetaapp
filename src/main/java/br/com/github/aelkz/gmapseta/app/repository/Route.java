...
public enum Route {
    ...
    TEST(99L,"undefined",27.4,"https://www.google.com.br/maps/dir/-15.6582846,-47.8024838/SMAS+Trecho+1+ParkShopping+Bras%C3%ADlia+-+Guar%C3%A1,+Bras%C3%ADlia+-+DF/@-15.7525637,-47.9722424,13z/data=!4m8!4m7!1m0!1m5!1m1!1s0x935a3029eaad68b7:0xc4985755bc8593cc!2m2!1d-47.955359!2d-15.833826",Point.EMPTY,Point.EMPTY)
    ;
    ...
    public static List<Route> getRoutesBy(Point startingPoint) {
        ...
        for (Route route: Route.values()) {
            if (route.getStartingPoint().getId().equals(startingPoint.getId())) {
                routes.add(route);
            }
        }
